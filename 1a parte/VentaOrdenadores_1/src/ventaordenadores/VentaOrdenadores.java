            ...
            else
            {
                if(jTextFieldNombreCliente.getText().length()>15)
                {
                    ...
                    if(!jTextFieldNombreCliente.getText().matches("[a-zA-Z áéíóúÁÉÍÓÚ\\s]{1,15}")){
                        JOptionPane.showMessageDialog(this, "La caja de texto no admite caracteres extraños(no acepta guiones, ni puntos, ni números, etc).", "ERROR.", JOptionPane.ERROR_MESSAGE);
                        estadoInicial();
                    }else
                    {
